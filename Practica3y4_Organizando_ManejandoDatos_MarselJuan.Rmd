...
```{r}
weather_t <- weather %>% pivot_longer(cols = starts_with("d"), names_to = "dia", values_to = "valor",values_drop_na = TRUE) %>% pivot_wider(names_from="element", values_from = "dia") %>% mutate()
